...
Description: Simple adding input fields in your post, pages and templates. Fields contains WP admin section and Bootstrap classes. You able to use function or shortcode.
Version: 1.3
...
function get_oitemp( $template, $atts ) {
	foreach ( $atts as $key => $value ) {

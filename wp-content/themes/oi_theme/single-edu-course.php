<?php
/*
 * Template Name: Курс по разработке
		...
		$data = array(
			...
			'about_description' => array(
				...
				array(
					...
					'description' => 'Большенством технологий, которыми вы овладеете, пользуются все без исключения сайты, что создает огромный спрос на специалистов.',
				),
			),
		);
		...
		$data = array(
			...
			'about_description' => array(
				...
				array(
					'image'       => '',
					'title'       => 'Перспективы развития',
					'description' => 'JavaScript является не только языком на котором разрабатывают front-end, но так же на нем пишут и back-end, что расширяет возможности разработчика и увеличивает его заработок.',
				),
				array(
					'image'       => '',
					'title'       => 'Популярность технологий',
